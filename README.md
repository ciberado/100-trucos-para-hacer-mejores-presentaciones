...
* Ayuda a estructurarte y a entrar en detalle
...
* Workflow de creación de presentaciones
...
* Tu charla tiene que aportar un valor concreto al asistente, hazle ver cómo mejora eso su vida
...
* Practica la presentación delante de una audiencia, aunque esté compuesta por peluches de tus hijos. Visualiza la situación real
* Las charlas más sencillas de ejecutar son las que duran entre 40 y 55 minutos: tienes el tiempo necesario para contar tu historia, pero no tanto como para que la mayoría de la gente que asiste se aburra
* Es bastante difícil mantener la atención de una audiencia durante varias horas. Si el formato implica esta duración, es muy buena idea presentar entre al menos dos personas para reducir la fatiga de todas y todos. Introduce también pausas cada hora, sin excepciones
* Las charlas más difíciles de realizar, con mucha diferencia, son las que duran 10 minutos. No tienes margen de error y resulta complicado hacerlas memorables. En este caso, es importantísimo centrarte en una única idea
...
* La estructura más sencilla y potente es: mostrar un punto de dolor de la audiencia, asegurar que vas a resolverlo y mostrarles qué pueden conseguir siguiendo lo que has explicado (pain, claim, gain). Tres actos, como en el cine
...
* Recuerda que una buena historia le sucede a una persona concreta o (en el peor de los casos) a un colectivo pequeño
...
* No te enfrentes a las creencias de tu audiencia directamente, dales un punto de escape que les permita llegar a tus mismas conclusiones. Esto es especialmente importante si nos referimos a ideologías, pero también a prácticas que asumen como obvias
...
* Reduce la carga cognitiva (John Sweller) eliminando redundancia. La memoria de trabajo es muy limitada y si tanto el instructor como la slide repite contenido es difícil concentrarse en ambos.
...
* Un background puede ser evocador incluso si aplicas un efecto blur fuerte que facilita el contraste: nuestros cerebros completan la imagen
...
* Haz fluir las slides discretamente para no interrumpir el ritmo. Invierte en un pequeño pasador de transparencias
...
* Revisa todos los ejemplos propuestos por Garr Raynolds
...
* Cuando enseñes fragmentos de código asegúrate de mostrar solo la parte relevante, elimina todo lo superficial sin importar la sintaxis
...
* Consigue una sala iluminada: los proyectores modernos son potentes y la oscuridad aturde
...
* Presentando
* A veces escucho música para motivarme antes de empezar. Know your enemy de Green Day nunca falla
...
* Prepara, prepara, prepara y prepara tu charla
...
* Una estructura lógica de discurso es fundamental
* Usa un hilo conductor con impacto emocional
* Apela al miedo, potencia la excitación, genera una sonrisa, despierta ternura
...
* Utiliza ejemplos lo menos abstractos posibles, hazlo aplicable
...
* En una pizarra una explicación florece y resulta muchísimo más potente que un diagrama estático
...
* No hables rápido a menos que tengas una excelente pronunciación
...
* Las manos son un instrumento de comunicación poderoso: déjate llevar gesticulando y úsalas para señalar zonas concretas de lo que estás proyectando
...
* Evita caer en los clichés de una TED talk: están muy vistos. No dejes de ver ‘Thought Leader’ gives talk that will inspire your thoughts
...
* En general el feedback positivo es una muestra de que los demás aprecian lo que has hecho, no de que eres el mejor orador desde Martin Luther King. Relativízalos
...
* Por mucho que te pueda apetecer tras escuchar un mal comentario, no lances a la gente contra de personas particulares. Todas las quemas de brujas en redes sociales son injustas, todas
